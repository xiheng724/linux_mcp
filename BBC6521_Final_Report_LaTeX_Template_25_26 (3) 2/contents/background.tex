...
Suppose an attacker replaces a registered tool's JSON-RPC payload at runtime so that the \texttt{operation} field now targets a different backend handler, while the socket address and the enclosing syscalls stay identical.
