...
Table~\ref{tab:comparison} contextualises \texttt{linux-mcp} against two representative user-space frameworks, the monolithic-gateway OpenClaw~\cite{openclaw2026} and the in-process Hermes Agent~\cite{nousresearch2026hermesagent}, across the control-plane properties most relevant to this work.
