...
The kernel placement therefore protects against two specific failure modes: (a) logic bugs in the gateway that would otherwise mis-handle control-plane state, and (b) unprivileged co-located adversaries observing or forging JSON-RPC traffic. It does not protect against a gateway whose process memory has been directly compromised.
