...
Modern eBPF can perform bounded map lookups, so runtime hash checks are not the hard part; the harder part is representing approval tickets and other state that spans multiple messages.
