...
The protocol is deliberately minimal, consistent with the design goal in \ref{sec:design-goals} that tool authors should not need to reason about the control plane, so the tool service need not be aware of sessions, agent identities, or kernel tickets.
