...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\linewidth]{figures/figure_latency_mean_by_payload.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.8\linewidth]{figures/figure_latency_overhead.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\linewidth]{figures/figure_latency_p95_by_payload.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\linewidth]{figures/figure_latency_breakdown.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.8\linewidth]{figures/figure_attack_heatmap.png}
