...
A caveat: the harness selectively weakens the baseline's code paths per category (\texttt{tamper\_\allowbreak session}, \texttt{tamper\_\allowbreak approval}, \texttt{tamper\_\allowbreak metadata}, \texttt{compromised\_\allowbreak userspace}) so that each test exercises the specific check it targets.
