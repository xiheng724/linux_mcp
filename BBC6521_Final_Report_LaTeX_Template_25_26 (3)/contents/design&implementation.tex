...
The cost is that a full kernel module is needed rather than a policy hook or a BPF program, but for a research prototype this is an acceptable trade-off. In practice, the module's role stayed narrow enough that the added complexity remained manageable.
