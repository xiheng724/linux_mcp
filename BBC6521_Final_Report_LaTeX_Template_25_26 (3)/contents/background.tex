...
In these settings, the system must preserve consistency between tool descriptions, permissions, and runtime behaviour, a requirement that traditional OS abstractions (process isolation, file access controls, inter-process messaging) do not directly address.
...
Prompt injection attacks operate at the semantic layer of the agent's planning loop, manipulating the model's reasoning through adversarial input to cause it to choose an unintended tool or construct a malicious payload.
