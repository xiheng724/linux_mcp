...
For example, proposes embedding LLM-centric services into a system-level kernel that manages scheduling, memory, and tool access for agents \cite{packer2024memgpt, zhang2024llmos, wu2024oscopilot}. 
