...
Conversely, any modification to a semantically significant field---the input schema, risk tags, description, approval policy, or path semantics---yields a different hash, which the kernel detects as a mismatch upon the next \texttt{TOOL\_REQUEST}.
